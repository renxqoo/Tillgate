...
import { LOCALE_COOKIE, LOCALE_COOKIE_MAX_AGE, type Locale } from "@ai-gateway/api-client/i18n";
...
export function LocaleSwitcher() {
  ...
  return (
    <Button size="sm" variant="ghost" onClick={toggle} disabled={pending} aria-label={t("switchLocale")}>
      <LanguagesIcon />
