...
| 测试文件                                   | 覆盖                                                                                                                                                                                                                                                                                                       | 关键断言来源                                   |
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| `architecture.test.ts`                     | 边界门禁：src/**（除 next/）无 `next/` import；全包无 `@tokenlens/*`；package.json 依赖闭包；exports 恰 `.`+`./next`；根/next 出口运行时词表逐一锁定                                                                                                                                                       | 铁律 11、DESIGN §5；收编 v1 api-path-contract  |
