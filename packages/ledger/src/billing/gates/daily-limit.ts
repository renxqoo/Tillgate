...
import type { AuthorizeBillingCommand } from '../types.js';
import type { DomainTx } from '../../platform/operations.js';
import { billingDayStart } from '../daily-window.js';
import { DailySpendLimitExceededError } from '../../platform/errors.js';
 ...
 */
/** S5 重写：每日限额与来源解析（自 authorize/limits.ts 平移，行为零变更） */
