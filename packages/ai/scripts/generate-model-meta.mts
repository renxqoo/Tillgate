 ...
 *
 *   pnpm --filter @ai-gateway/ai model-meta                    # 优先抓取 models.dev
 *   pnpm --filter @ai-gateway/ai model-meta -- <snapshot.ts>   # 离线：解析 pi-ai models.generated.ts
 *
 * 产物（均入库，随包发版）：
...
function emitContextWindowMap(seeds: SeedModel[]): void {
  ...
  const lines: string[] = [
    '// 本文件由 scripts/generate-model-meta.mts 生成——勿手改（重跑：pnpm --filter @ai-gateway/ai model-meta）',
