...
export function createInMemoryPaymentStores() {
  ...
  const orderStore: import('../ports/payment-ports.js').PaymentOrderStore = {
  ...
  const codeStore: import('../ports/payment-ports.js').RedeemCodeStore = {
...
export function createInMemoryRateCounter(failAfter?: number) {
  ...
  return {
    ...
    } as import('../ports/payment-ports.js').RateCounterPort,
    counters,
