...
/** 用户费率卡绑定(报价快照,v1 findRateCardId;null=系数 1) */
...
/** 组织成员限额读模型(订阅授权管线 probe,v1 memberLimits:日限 a/子配额 b) */
