...
export const AccountsErrors = defineErrorCatalog('accounts', {
  ...
  email_invalid: { category: 'invalid_input', message: 'Invalid email address', zh: '邮箱格式不合法' },
  ...
  rate_card_not_found: { category: 'not_found', message: 'Rate card not found', zh: '费率卡不存在' },
  ...
  key_already_revoked: { category: 'conflict', message: 'API key already revoked', zh: 'API Key 已吊销' },
  key_patch_invalid: { category: 'invalid_input', message: 'API key fields invalid', zh: 'API Key 字段不合法' },
  ...
  app_already_disabled: { category: 'conflict', message: 'Application already disabled', zh: '应用已禁用' },
  app_patch_invalid: { category: 'invalid_input', message: 'Application fields invalid', zh: '应用字段不合法' },
  app_scope_invalid: { category: 'invalid_input', message: 'App scope invalid', zh: '应用限制项不合法' },

  // ---- 组织/成员/邀请 ----
  org_not_found: { category: 'not_found', message: 'Organization not found', zh: '组织不存在' },
  org_forbidden: { category: 'forbidden', message: 'Owner role required', zh: '需要组织所有者权限' },
  org_no_subscription: {
    category: 'conflict',
    message: 'Organization has no active subscription',
    zh: '组织没有有效订阅',
  },
  seats_full: { category: 'conflict', message: 'All subscription seats are occupied', zh: '订阅席位已满' },
  invitations_full: {
    category: 'conflict',
    message: 'Too many pending invitations',
    zh: '待接受邀请数量已达上限',
  },
  invitation_invalid: { category: 'not_found', message: 'Invitation not found', zh: '邀请不存在或已失效' },
  ...
  member_not_found: { category: 'not_found', message: 'Organization member not found', zh: '成员不存在' },
  ...
  // ---- 推荐与拉新参数 ----
  referral_invalid_code: { category: 'invalid_input', message: 'Invalid referral code', zh: '邀请码不合法' },
  referral_self_invite: { category: 'conflict', message: 'Cannot refer yourself', zh: '不能邀请自己' },
  ...
  relation_not_found: { category: 'not_found', message: 'Referral relation not found', zh: '推荐关系不存在' },
});
