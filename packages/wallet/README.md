...
`bun run --filter @ai-gateway/wallet test`。
...
```bash
bun run --filter @ai-gateway/wallet typecheck
bun run --filter @ai-gateway/wallet lint
bun run --filter @ai-gateway/wallet test
bun run --filter @ai-gateway/wallet build
```
