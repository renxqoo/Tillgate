/**
 * @tillgate/db 公共出口:连接、事务、schema、迁移、PG 错误分类。
 * 业务 SQL / Repository CRUD / PG→HTTP 翻译不在此(零内部依赖)。
 */
...
export type { LockDefectHook, SessionTryLockInput } from './advisory-try-lock.js';
...
// ---- schema(46 表(基线 39 + identity 七表,迁移 0076) + 词表 + relations;另有 ./schema 子入口)----
