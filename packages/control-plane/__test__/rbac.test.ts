...
describe('RBAC 矩阵穷举（80 格 = DESIGN §2.4 字面矩阵）', () => {
  ...
  const EXPECTED: Record<AdminRole, Record<string, boolean>> = {
    super_admin: {
      ...
      'funds:read': true, 'funds:write': true,
      'catalog:read': true, 'catalog:write': true,
      'plans:read': true, 'plans:write': true,
      'ops:read': true, 'ops:write': true,
      'growth:read': true, 'growth:write': true,
      'settings:read': true, 'settings:write': true,
      'admins:read': true, 'admins:write': true,
    },
    operator: {
      'users:read': true, 'users:write': true,
      'funds:read': true, 'funds:write': false,
      'catalog:read': true, 'catalog:write': true,
      'plans:read': true, 'plans:write': true,
      'ops:read': true, 'ops:write': true,
      'growth:read': true, 'growth:write': true,
      'settings:read': true, 'settings:write': true,
      'admins:read': false, 'admins:write': false,
    },
    finance: {
      'users:read': true, 'users:write': false,
      'funds:read': true, 'funds:write': true,
      'catalog:read': true, 'catalog:write': false,
      'plans:read': true, 'plans:write': false,
      'ops:read': true, 'ops:write': false,
      'growth:read': true, 'growth:write': false,
