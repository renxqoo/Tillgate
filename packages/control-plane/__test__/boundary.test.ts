...
describe('错误目录码表封闭（词表 == DESIGN §2.3）', () => {
  it('码集合快照', () => {
    expect([...controlPlaneErrors.codes].toSorted()).toEqual([
      ...
      'control_plane.invalid_debit_floor',
      ...
      'control_plane.invalid_platform_currency',
      'control_plane.invalid_protocol',
      'control_plane.invalid_provider_input',
      'control_plane.invalid_reservation_limit',
      'control_plane.invalid_reservation_policy',
      ...
      'control_plane.platform_currency_locked',
