    ...
    <>
      ...
      <main className="mx-auto max-w-6xl space-y-6 p-4">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b text-left text-xs text-muted-foreground">
                      ...
                      <th className="py-2 pr-4 text-right">输入价(元/M)</th>
                      <th className="py-2 pr-4 text-right">输出价(元/M)</th>
                      <th className="py-2 pr-4 text-right">缓存价(元/M)</th>
        ...
        <p className="text-xs text-muted-foreground">
          价格单位：元/百万 token（官方价）。对外模型名是客户端在 <code>model</code> 字段填的名字，映射到上游真实模型 + 渠道。
        </p>
      </main>
    </>
  );
