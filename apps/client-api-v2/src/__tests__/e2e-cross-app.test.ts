/**
 * E2E ④ 跨 app 全链（client-api-v2 + gateway-v2 双真服务 + 真上游 RX-M3）：
...
// 跨 app 复用 gateway-v2 的 E2E 基建（真网关装配 + 平台对账工具）
import { E2EKeys, e2ePost, startE2EGateway, E2E_MODEL, type E2EGateway } from '../../../gateway-v2/src/__tests__/e2e-kit.js';
