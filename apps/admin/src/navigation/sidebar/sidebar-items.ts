  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'channel-funds', title: 'channelFunds', url: '/dashboard/channel-funds', icon: Wallet },
        ...
        { id: 'payment-orders', title: 'paymentOrders', url: '/dashboard/payment-orders', icon: CreditCard },
      ],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      label: 'groupRedeem',
      items: [
        { id: 'redeem-batches', title: 'redeemBatches', url: '/dashboard/redeem-batches', icon: Ticket },
      ],
    },
    {
      id: 5,
