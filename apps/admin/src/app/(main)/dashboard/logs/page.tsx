  ...
  const columns: DataTableColumn<LogRow>[] = [
    {
      key: "requestId",
      header: "Request ID",
      render: (l) => <code className="text-xs text-muted-foreground">{l.requestId.slice(0, 8)}</code>,
    },
    {
      key: "userName",
      header: tc("user"),
    ...
    },
    {
      ...
      render: (l) => <span className="text-xs text-muted-foreground">{fmtDateTime(l.createdAt)}</span>,
    },
    {
      key: "errorCode",
      header: t("errorCode"),
